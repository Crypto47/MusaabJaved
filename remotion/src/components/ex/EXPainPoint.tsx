...
interface EXPainPointProps {
  pain: string;
}

export function EXPainPoint({ pain }: EXPainPointProps) {
  ...
  return (
    <div style={{
      ...
      background: "linear-gradient(135deg, #0f0212 0%, #190520 45%, #0f0212 100%)",
