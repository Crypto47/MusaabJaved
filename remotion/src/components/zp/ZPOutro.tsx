...
export function ZPOutro() {
  ...
  return (
    <div style={{
      ...
      background: "linear-gradient(160deg, #030d06 0%, #061a0c 60%, #030d06 100%)",
      ...
      <div style={{
        ...
        background: "radial-gradient(circle at bottom left, rgba(251,146,60,0.09) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />

      <div style={{
        fontSize: "20px", letterSpacing: "8px", fontWeight: 700, color: "#4ade80",
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, transparent, #4ade80, #fb923c, transparent)",
      ...
      <div style={{
        ...
        background: "linear-gradient(90deg, #4ade80 0%, #86efac 50%, #fb923c 100%)",
